...
const Navbar = () => {
  ...
  return (
    <nav
      dir="rtl"
      className="bg-white/80 backdrop-blur-md shadow-md fixed top-0 right-0 left-0 z-50"
    >
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        >
          ...
          {/* اللغة */}
          <select className="border-none text-sm text-black bg-transparent focus:outline-none mr-5">
