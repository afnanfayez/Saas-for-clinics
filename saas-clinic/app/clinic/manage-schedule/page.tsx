            ...
            <div className="divide-y divide-gray-100 max-h-[600px] overflow-y-auto">
              {doctors.map(doctor => (
                <button
                  ...
                  className={`w-full text-left p-4 hover:bg-teal-50 transition-colors flex flex-col gap-1 ${
                    selectedDoctor?.user_id === doctor.user_id ? 'bg-teal-50 border-l-4 border-teal-500' : ''
                  }`}
                >
               ...
               <form onSubmit={handleSave} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-8">
                 ...
                 <div className="flex justify-end pt-4 border-t border-gray-100">
                   <button
                     ...
                     className={`px-6 py-2 bg-teal-600 text-white rounded-lg font-medium shadow-sm hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors ${
                       (saving || availableDays.length === 0) ? 'opacity-50 cursor-not-allowed' : ''
                     }`}
                   >
                     {saving 
