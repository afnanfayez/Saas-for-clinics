      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="bg-white shadow-2xl rounded-2xl overflow-hidden mt-16">
          ...
          <div className="px-8 py-8">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 text-sm">{t.signInPrompt}</p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={
                      language === "en"
                        ? "admin@platform.com or 0599123456"
                        : "admin@platform.com أو 0599123456"
                    }
                  />
                </div>
                {errors.login && (
        ...
        <div className="mt-6 bg-white/80 backdrop-blur-sm rounded-lg p-4 shadow-md">
          ...
          <div className="text-xs text-gray-600 space-y-1">
            <p>
              <strong>{t.admin}</strong> admin@platform.com
            </p>
            <p>
              <strong>{t.manager}</strong> manager@clinic.ps
            </p>
            <p>
              <strong>{t.doctorLabel}</strong> doctor@clinic.ps
            </p>
          </div>
        </div>
      </div>
